  ...
  return (
    <form className="filter-form">
      ...
      <section id="filter-section-meal">
        ...
        <article className="filter-label-input-pair">
          <label htmlFor="filter-dessert">Dessert</label>
          <input id="filter-dessert" type="checkbox" name="meal" value="dessert" onChange={handleChange} checked={mealFilterObject["dessert"]} />
        </article>
        <article className="filter-label-input-pair">
